...
Route::group(['prefix' => 'admin', 'as' => 'admin.'], function () {
    ...
    Route::resource('materials',MaterialsController::class); // CRUD by Rimon
    Route::resource('suppliers',SuppliersController::class); // CRUD by Rimon
    ...
    Route::resource('unit-type',UniteTypeController::class); // CRUD by Rimon
